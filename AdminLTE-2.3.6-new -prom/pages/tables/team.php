      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
			...
			<button class="btn btn-success" data-toggle="modal" data-target="#add_new_record_modal1080">Add New Record</button>

			  <div class="col-md-9">
			                <h1 class="box-title"><b>TEAM</b></h1>
...
<div class="modal fade" id="add_new_record_modal1080" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<div class="modal fade" id="view_team_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
             <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h2 class="modal-title" id="myModalLabel"><b><output id ="view_team_name" style="display:inline; font-size:80%;"> </output></b></h2>
            </div>
            <div class="modal-body">
                    ...
                    <div id="mainb">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5 project_detail">
                                <p class="ng-binding"><span class="title control-label">Team ID:</span><output id ="view_team_id" style="display:inline"> </output></p>
                                <p class="ng-binding"><span class="title control-label">Team Lead:</span><output id ="view_team_lead" style="display:inline"> </output></p>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" onclick="DeleteTeam1()" >Delete</button>
                <input type="hidden" id="hidden_delete_team_id">
            </div>
        </div>
    </div>
</div>
