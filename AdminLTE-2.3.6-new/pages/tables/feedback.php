...
<div class="modal fade" id="view_feedback_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
             <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h2 class="modal-title" id="myModalLabel"><b><output id ="view_id22" style="display:inline; font-size:80%;"> </output></b></h2>
            </div>
            <div class="modal-body">
                    ...
                    <div id="mainb">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5 project_detail">
                                <p class="ng-binding"><span class="title control-label">User ID:</span><output id ="view_user_id1" style="display:inline"> </output></p>
                                <p class="ng-binding"><span class="title control-label">Ans-1:</span><output id ="view_ans_1" style="display:inline"> </output></p>
                                <p class="ng-binding"><span class="title control-label">Ans-2:</span><output id ="view_ans_2" style="display:inline"> </output></p>
                                <p class="ng-binding"><span class="title control-label">Ans-3:</span></span><output id ="view_ans_3" style="display:inline"></p>
                                <p class="ng-binding"><span class="title control-label">Ans-4:</span></span><output id ="view_ans_4" style="display:inline"></p>
                                <p class="ng-binding"><span class="title control-label">Ans 5:</span></span><output id ="view_ans_5" style="display:inline"></p>
                                <p class="ng-binding"><span class="title control-label">Remarks:</span></span><output id ="view_remarks" style="display:inline"></p>
                                <p class="ng-binding"><span class="title control-label">Contact ID:</span></span><output id ="view_contact_id" style="display:inline"></p>
                            </div>
                        </div>
                    </div>
                    <!-- end main details -->
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" onclick="DeleteFeedback1()" >Delete</button>
                <input type="hidden" id="hidden_delete_feedback_id">
            </div>
        </div>
    </div>
</div>
